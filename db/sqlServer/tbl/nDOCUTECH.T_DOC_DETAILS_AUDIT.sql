...
*	Desc: Docutech Doc Details Audit Table
*	Object:  Table [nDOCUTECH].[T_DOC_DETAILS_AUDIT]    Script Date: 12/9/2019
**/

DROP TABLE [nDOCUTECH].[T_DOC_DETAILS_AUDIT]
GO
...
CREATE TABLE [nDOCUTECH].[T_DOC_DETAILS_AUDIT](
	id_doc_details_key 		int 					 	NOT NULL,
	...
	CONSTRAINT [pk_doc_details_audit_key] PRIMARY KEY NONCLUSTERED 
(
	[id_doc_details_key] ASC,
	[id_doc_details_ver] ASC
