...
/****** Object:  StoredProcedure [nDOCUTECH].[ACT_doc]    Script Date: 9/11/2019 5:47:36 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SELECT @g_dtt_log = GETDATE(), @g_tx_sp_name = 'ACT_doc.sp', @g_id_line_num = 326
	...
	BEGIN
		...
		END
			...
			EXEC @g_id_return_status = nDOCUTECH.INS_doc
										...
										, @tx_invoice_number 		varchar(16)x_invce_number 		varchar(16)					, @tx_account_number 	= @tx_account_number 	
