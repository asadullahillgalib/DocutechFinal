...
Ext.define("nazdaq.constants.ActionType", {
	...
	requires: ["nazdaq.constants.ActionType"],
	statics: {
		...
		ACTION_TYPE_APPROVE          : "APPROVE",
		ACTION_TYPE_REJECT           : "REJECT",
		ACTION_TYPE_LOGIN            : "LOGIN",
		ACTION_TYPE_NEW              : "NEW",
		ACTION_TYPE_SELECT_SINGLE    : "SELECT_SINGLE"
	}
});
...
Ext.define("nazdaq.constants.ContentType", {
	...
	requires: ["nazdaq.constants.ContentType"],
	statics: {
		...
		CONTENT_TYPE_SMS_SYNC       : "SmsSync",
		CONTENT_TYPE_PARSED_SMS     : "ParsedSms"
	}
});
...
Ext.define("nazdaq.constants.StatusType", {
	...
	requires: ["nazdaq.constants.StatusType"],
	statics: {
		STATUS_TYPE_OK              : "OK",
...
Ext.define('nazdaq.constants.Grid', {
	...
	downloadExcelXml: function(includeHidden, title) {
		...
		*/
		...
		if (Ext.isChrome) {
			...
			var location = 'data:application/vnd.ms-excel;base64,' + Base64.encode(vExportContent.replaceAll('OFAC','SCREEN'));
			...
			form = this.add({
				...
				hidden: true,
				standardSubmit: true,
				url: 'http://webapps.figleaf.com/dataservices/Excel.cfc?method=echo&mimetype=application/vnd.ms-excel&filename=' + escape(title + ".xlsx"),
				items: [{
					xtype: 'hiddenfield',
					name: 'data',
	...
	*/
	getExcelXml: function(includeHidden, title, headerLabel) {

		var theTitle = title || this.title;
		var headerLabel = headerLabel;

		var worksheet = this.createWorksheet(includeHidden, theTitle, headerLabel);
	...
	*/
	...
	createWorksheet: function(includeHidden, theTitle, headerLabel) {
		...
		var t = ''.concat(
			...
			'<html:b>AL-ARAFAH ISLAMI BANK&#10;</html:b><html>' + theTitle + '</html></Data><NamedCell ss:Name="Print_Titles">',
			'</NamedCell></Cell>',
			'</Row>',
